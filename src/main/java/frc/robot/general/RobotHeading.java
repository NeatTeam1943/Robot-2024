...
public enum RobotHeading {
  INTAKE(
      DriveTrainConstants.kIntakeHeadingLeftInverted,
      DriveTrainConstants.kIntakeHeadingRightInverted),
  SHOOTER(
      DriveTrainConstants.kShooterHeadingLeftInverted,
      DriveTrainConstants.kShooterHeadingRightInverted);
